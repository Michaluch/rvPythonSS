...
cur = db.cursor()
s = 'create database if not exists library_db default character set utf8 collate utf8_general_ci'
cur.execute(s)
...
cur.execute('''create table if not exists books_monitor(
  id int unsigned auto_increment,
...
cur.execute('''create database if not exists courses_db
  default character set utf8 collate utf8_general_ci;''')

cur.execute('''use courses_db;''')
...
cur.execute('''create table if not exists courses_difficulty(
   id int unsigned auto_increment,
   name varchar(60) not null,
   primary key (id)
 );''')

cur.execute('''create table if not exists entity_type(
  id int unsigned auto_increment,
  name varchar(60) not null,
  primary key (id)
);''')
...
cur.execute('''create table if not exists course_subscriptions(
  id int unsigned auto_increment,
...
cur.execute('''create table if not exists lecture_books(
  id int unsigned auto_increment,
...
cur.execute('''create table if not exists rating_details(
  id int unsigned auto_increment,
  user_id int unsigned not null,
...
cur.execute('''create table if not exists test_answers(
  id int unsigned auto_increment,
...
cur.execute('''create table if not exists grade_details(
  id int unsigned auto_increment,
...
cur.execute('''create user 'librarian'@'localhost' identified by 'lu6574hlrt';''')
cur.execute('''grant insert, update, delete, select, create view on library_db.* to 'librarian'@'localhost';''')

cur.execute('''create user 'courses_master'@'localhost' identified by 'ytmktm867';''')
cur.execute('''grant insert, update, delete, select, create view on courses_db.* to 'courses_master'@'localhost';''')
cur.execute('''grant select on library_db.category to 'courses_master'@'localhost';''')
cur.execute('''grant select on library_db.subject to 'courses_master'@'localhost';''')
cur.execute('''grant select on library_db.library_books to 'courses_master'@'localhost';''')
